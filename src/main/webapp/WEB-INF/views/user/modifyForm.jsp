					...
					<div id="modifyForm">
						<form action="/mysite3/user" method="get">
							...
							<div class="form-group">
								...
								<input type="hidden" id="input-id" name="id" value="<%=authUser.getId()%>" placeholder="아이디를 입력하세요"	>
							...
							<div class="form-group">
								...
								<input type="hidden" id="input-no" name="no" value="<%=authUser.getNo()%>" placeholder="">
							<!-- 버튼영역 -->
